...
**Last updated:** Sat 19 Sep 18:35 EDT — Backboard now provisions an isolated document-backed Assistant per shopper, writes memory automatically for identified shoppers, and recalls it across new negotiations and local server restarts (Codex/Ricardo).
