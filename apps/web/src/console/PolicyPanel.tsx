...
export function PolicyPanel({ policy, products, port, onPolicy, onDraft }: { policy: Policy; products: OwnerProduct[]; port: ConsolePort; onPolicy(policy: Policy): void; onDraft?: (draft: Pick<Policy, "floorPct" | "askOwner">) => void }) {
